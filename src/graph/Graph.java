...
/**
 * Graph, der gerichtet oder ungerichtet sein kann. Der Graph ist gewichtet.
 * Falls keine Gewichte angegeben werden, dann sind die Gewichte implizit auf 1
 * gesetzt. Der Graph einthÃ¤lt keine Mehrfachkanten und keine Schleifen (Kanten
 * von Knoten zu sich selbst).
 *
...
public interface Graph<V> {
     ...
     * @param v Startknoten
     * @param w Zielknoten
     * @throws IllegalArgumentException falls einer der Knoten nicht im Graph
     * vorhanden ist oder Knoten identisch sind.
    ...
    /**
     * Liefert eine Liste aller adjazenter Knoten zu v. Genauer:
     * g.getAdjacentVertexList(v) liefert eine Liste aller Knoten w, wobei (v,
     * w) eine Kante des Graphen g ist.
     *
     * @param v Knoten
    ...
    /**
     * Liefert eine Liste aller inzidenten Kanten. Genauer:
     * g.getIncidentEdgeList(v) liefert eine Liste aller Kanten im Graphen g mit
     * v als Startknoten.
     *
     * @param v Knoten
     * @throws IllegalArgumentException falls Knoten v nicht im Graph vorhanden
